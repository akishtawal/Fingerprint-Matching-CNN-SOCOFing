...
# sample_fraction = 0.75  # Use 20% of the data
...
loss, precision, recall, accuracy = model.evaluate([x_val[:, :, :, np.newaxis], x_val[:, :, :, np.newaxis]], y_true_binary)
...
model.save('SOCOFing_Fingerprint_Matching.keras')